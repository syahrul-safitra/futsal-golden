...
use App\Models\JadwalLapanganB;
...
class JadwalLapanganBController extends Controller
{
    /**
    ...
    {
        return view('admin.sewa.index2', [
            'data' => JadwalLapanganB::with('member')->latest()->get()
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        JadwalLapanganB::create($data);

        $file->move('bukti_pembayaran', $rename);

        return redirect('/field_b')->with('success', 'Berhasil booking lapangan, silahkan tunggu beberapa saat karena admin sedang memverifikasi data!');
     ...
     */
    public function show(JadwalLapanganB $jadwalLapanganB)
    {
        //
    }
     ...
     */
    public function edit(JadwalLapanganB $jadwalLapanganB)
    {
        //
    }
     ...
     */
    public function update(Request $request, JadwalLapanganB $jadwalLapanganB)
    {
        //
    }
     ...
     */
    public function destroy(JadwalLapanganB $data)
    {

        if ($data->kode_booking) {
            JadwalLapanganB::where('kode_booking', '=', $data->kode_booking)->delete();
    ...
    public function lihatJadwal()
    {
        ...
        $dataTanggal1 = JadwalLapanganB::whereDate('waktu_mulai', '=', $tanggal1->format('Y-m-d'))->get();
        $dataTanggal2 = JadwalLapanganB::whereDate('waktu_mulai', '=', $tanggal2->format('Y-m-d'))->get();
        $dataTanggal3 = JadwalLapanganB::whereDate('waktu_mulai', '=', $tanggal3->format('Y-m-d'))->get();
        $dataTanggal4 = JadwalLapanganB::whereDate('waktu_mulai', '=', $tanggal4->format('Y-m-d'))->get();
        $dataTanggal5 = JadwalLapanganB::whereDate('waktu_mulai', '=', $tanggal5->format('Y-m-d'))->get();
        $dataTanggal6 = JadwalLapanganB::whereDate('waktu_mulai', '=', $tanggal6->format('Y-m-d'))->get();
    ...
    public function konfirmasi(JadwalLapanganB $data)
    {
    ...
    public function changeBukti(Request $request, jadwalLapanganB $data)
    {
        ...
        if ($data->kode_booking) {
            ...
            JadwalLapanganB::where('kode_booking', '=', $kode)->update([
    ...
    public function jadwalEvent()
    {
        ...
        $dataTanggal1 = JadwalLapanganB::whereBetween('waktu_mulai', [$tanggal1->format('Y-m-d 09:00:00'), $tanggal1->format('Y-m-d 19:00:00')])->get();
        $dataTanggal2 = JadwalLapanganB::whereBetween('waktu_mulai', [$tanggal2->format('Y-m-d 09:00:00'), $tanggal2->format('Y-m-d 19:00:00')])->get();
        $dataTanggal3 = JadwalLapanganB::whereBetween('waktu_mulai', [$tanggal3->format('Y-m-d 09:00:00'), $tanggal3->format('Y-m-d 19:00:00')])->get();
        $dataTanggal4 = JadwalLapanganB::whereBetween('waktu_mulai', [$tanggal4->format('Y-m-d 09:00:00'), $tanggal4->format('Y-m-d 19:00:00')])->get();
        $dataTanggal5 = JadwalLapanganB::whereBetween('waktu_mulai', [$tanggal5->format('Y-m-d 09:00:00'), $tanggal5->format('Y-m-d 19:00:00')])->get();
        $dataTanggal6 = JadwalLapanganB::whereBetween('waktu_mulai', [$tanggal6->format('Y-m-d 09:00:00'), $tanggal6->format('Y-m-d 19:00:00')])->get();

        return view('member.lapanganBEvent', [
            'tanggal1' => $tanggal1,
            'tanggal2' => $tanggal2,
            'tanggal3' => $tanggal3,
            'tanggal4' => $tanggal4,
    ...
    public function storeEvent(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            // return $e;
            return redirect('sewa-for-event-b')->with('error', 'Boking jadwal untuk turnament failed!, Silahkan hubungi admin untuk informasi lebih lanjut');

        }
        DB::commit();

        return redirect('sewa-for-event-b')->with('success', 'Berhasil booking lapangan untuk turnament, tunggu beberapa saat untuk konformasi booking dari admin.');

    }

    public function laporan(Request $request)
    {
        $data = JadwalLapanganB::with('member')->whereBetween('waktu_mulai', [$request->tanggal_awal, $request->tanggal_akhir])->get();
        ...
        foreach ($data as $index => $row) {
            ...
            $pdf->Cell(25, 10, "Lapangan Semen", 1);
