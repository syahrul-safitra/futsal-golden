...
return new class extends Migration {
    ...
    {
        Schema::create('jadwal_lapangan_a_s', function (Blueprint $table) {
            $table->id();
            ...
            // $table->enum('status_booking', ['pending', 'booked', 'pending_turnament', 'booked_turnamnet'])->default('pending');
    ...
    {
        Schema::dropIfExists('jadwal_lapangan_a_s');
    }
};
