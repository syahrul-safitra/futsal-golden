        ...
        <div class="">
            ...
            <div class="container mx-auto px-4 sm:px-16 mt-10">
                <div class="collapse bg-success">
                    <div class="collapse-title text-md font-medium">Untuk siswa (sd-sma) bermain pada pukul 09:00 - 14:00
                        akan
                        mendapatkan potongan harga menjadi Rp.50.000</div>
                </div>
                <h1 class="pt-8 mb-10 font-bold text-3xl">Jadwal Lapangan 2 <span class="text-orange-500">Futsal Ball</span>
                </h1>
                            ...
                            @foreach ($jamMain as $key => $item)
                                ...
                                @if ($data->isEmpty())
                                    <div class="rounded-lg border shadow-xl bg-white p-4 cursor-pointer transition duration-200 ease-in-out hover:shadow-xl"
                                        ...
                                        <div class="text-gray-900 font-bold text-2xl mt-2">Rp. 80.000</div>
                                    ...
                                    @else
                                        ...
                                        <div class="rounded-lg border shadow-xl bg-red-500 p-4 cursor-pointer transition duration-200 ease-in-out hover:shadow-xl"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="text-black-700 font-bold text-lg">
                                                    {{ $tanggal1->format('d-M') }}
                                                </div>
                                            </div>
                                            <div class="text-gray-900 font-semibold mt-2">
        ...
        <script>
            function toggleSelection(element) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href = `pembayaran2/${tanggal}/${jam}/${akunId}`;
                        }
                    });
            }
        </script>
